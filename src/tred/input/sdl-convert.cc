...
Key ToKey(SDL_Keysym key)
{
    switch (key.sym)
    {
        ...
        case SDLK_LEFTPAREN: return Key::LEFT_PAREN;
        case SDLK_RIGHTPAREN: return Key::RIGHT_PAREN;
        case SDLK_ASTERISK: return Key::ASTERIX;
        ...
        case SDLK_NUMLOCKCLEAR: return Key::NUMLOCK_CLEAR;
        case SDLK_KP_DIVIDE: return Key::KEYPAD_DIVIDE;
        case SDLK_KP_MULTIPLY: return Key::KEYPAD_MULTIPLY;
        ...
        case SDLK_KP_EQUALS: return Key::KEYPAD_EQUALS;
        ...
        case SDLK_VOLUMEUP: return Key::VOLUME_UP;
        case SDLK_VOLUMEDOWN: return Key::VOLUME_DOWN;
        case SDLK_KP_COMMA: return Key::KEYPAD_COMMA;
        case SDLK_KP_EQUALSAS400: return Key::KEYPAD_EQUALS_AS_400;
        case SDLK_ALTERASE: return Key::ALT_ERASE;
        ...
        case SDLK_RETURN2: return Key::SECOND_RETURN;
        case SDLK_SEPARATOR: return Key::SEPARATOR;
        case SDLK_OUT: return Key::OUT;
        case SDLK_OPER: return Key::OPER;
        case SDLK_CLEARAGAIN: return Key::CLEAR_AGAIN;
        case SDLK_CRSEL: return Key::CRSEL;
        case SDLK_EXSEL: return Key::EXSEL;
        case SDLK_KP_00: return Key::KEYPAD_00;
        case SDLK_KP_000: return Key::KEYPAD_000;
        case SDLK_THOUSANDSSEPARATOR: return Key::THOUSANDSEPARATOR;
        case SDLK_DECIMALSEPARATOR: return Key::DECIMALSEPARATOR;
        case SDLK_CURRENCYUNIT: return Key::CURRENCY_UNIT;
        case SDLK_CURRENCYSUBUNIT: return Key::CURRENCY_SUBUNIT;
        case SDLK_KP_LEFTPAREN: return Key::KEYPAD_LEFTPAREN;
        case SDLK_KP_RIGHTPAREN: return Key::KEYPAD_RIGHTPAREN;
        case SDLK_KP_LEFTBRACE: return Key::KEYPAD_LEFTBRACE;
        case SDLK_KP_RIGHTBRACE: return Key::KEYPAD_RIGHTBRACE;
        ...
        case SDLK_KP_XOR: return Key::KEYPAD_XOR;
        case SDLK_KP_POWER: return Key::KEYPAD_POWER;
        case SDLK_KP_PERCENT: return Key::KEYPAD_PERCENT;
        case SDLK_KP_LESS: return Key::KEYPAD_LESS;
        case SDLK_KP_GREATER: return Key::KEYPAD_GREATER;
        case SDLK_KP_AMPERSAND: return Key::KEYPAD_AMPERSAND;
        case SDLK_KP_DBLAMPERSAND: return Key::KEYPAD_DOUBLE_AMPERSAND;
        case SDLK_KP_VERTICALBAR: return Key::KEYPAD_VERTICAL_BAR;
        case SDLK_KP_DBLVERTICALBAR: return Key::KEYPAD_DOUBLE_VERTICLE_BAR;
        case SDLK_KP_COLON: return Key::KEYPAD_COLON;
        case SDLK_KP_HASH: return Key::KEYPAD_HASH;
        case SDLK_KP_SPACE: return Key::KEYPAD_SPACE;
        case SDLK_KP_AT: return Key::KEYPAD_AT;
        case SDLK_KP_EXCLAM: return Key::KEYPAD_EXCLAM;
        case SDLK_KP_MEMSTORE: return Key::KEYPAD_MEM_STORE;
        case SDLK_KP_MEMRECALL: return Key::KEYPAD_MEM_RECALL;
        case SDLK_KP_MEMCLEAR: return Key::KEYPAD_MEM_CLEAR;
        case SDLK_KP_MEMADD: return Key::KEYPAD_MEM_ADD;
        case SDLK_KP_MEMSUBTRACT: return Key::KEYPAD_MEM_SUBTRACT;
        case SDLK_KP_MEMMULTIPLY: return Key::KEYPAD_MEM_MULTIPLY;
        case SDLK_KP_MEMDIVIDE: return Key::KEYPAD_MEM_DIVIDE;
        case SDLK_KP_PLUSMINUS: return Key::KEYPAD_PLUS_MINUS;
        case SDLK_KP_CLEAR: return Key::KEYPAD_CLEAR;
        case SDLK_KP_CLEARENTRY: return Key::KEYPAD_CLEAR_ENTRY;
        case SDLK_KP_BINARY: return Key::KEYPAD_BINARY;
        case SDLK_KP_OCTAL: return Key::KEYPAD_OCTAL;
        case SDLK_KP_DECIMAL: return Key::KEYPAD_DECIMAL;
        case SDLK_KP_HEXADECIMAL: return Key::KEYPAD_HEXADECIMAL;
        case SDLK_LCTRL: return Key::CTRL_LEFT;
        case SDLK_LSHIFT: return Key::SHIFT_LEFT;
        case SDLK_LALT: return Key::ALT_LEFT;
        case SDLK_LGUI: return Key::GUI_LEFT;
        case SDLK_RCTRL: return Key::CTRL_RIGHT;
        case SDLK_RSHIFT: return Key::SHIFT_RIGHT;
        case SDLK_RALT: return Key::ALT_RIGHT;
        case SDLK_RGUI: return Key::GUI_RIGHT;
        case SDLK_MODE: return Key::MODE;
        case SDLK_AUDIONEXT: return Key::AUDIO_NEXT;
        case SDLK_AUDIOPREV: return Key::AUDIO_PREV;
        case SDLK_AUDIOSTOP: return Key::AUDIO_STOP;
        case SDLK_AUDIOPLAY: return Key::AUDIO_PLAY;
        case SDLK_AUDIOMUTE: return Key::AUDIO_MUTE;
        ...
        case SDLK_BRIGHTNESSDOWN: return Key::BRIGHTNESS_DOWN;
        case SDLK_BRIGHTNESSUP: return Key::BRIGHTNESS_UP;
        case SDLK_DISPLAYSWITCH: return Key::DISPLAYSWITCH;
        case SDLK_KBDILLUMTOGGLE: return Key::KEYBOARD_ILLUM_TOGGLE;
        case SDLK_KBDILLUMDOWN: return Key::KEYBOARD_ILLUM_DOWN;
        case SDLK_KBDILLUMUP: return Key::KEYBOARD_ILLUM_UP;
